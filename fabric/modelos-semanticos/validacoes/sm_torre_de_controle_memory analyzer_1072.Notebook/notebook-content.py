...
dataset = "sm_torre_de_controle" # Enter the name or ID of the semantic model
workspace = "Torre-de-Controle" # Enter the workspace name or ID in which the semantic model exists
